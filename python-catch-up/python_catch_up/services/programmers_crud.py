...
async def __to_schema_programmer(programmer: Type[models.Programmer]) -> schemas.Programmer:
    technologies = [schemas.Technology(id=i.id, name=i.name) async for i in programmer.technologies] 
    programmer = schemas.Programmer(id=programmer.id, name=programmer.name, technologies=technologies)
    return programmer
...
async def get_programmers() -> List[schemas.Programmer]:
    ...
    for orm_programmer in programmers:
        ...
        programmer = await __to_schema_programmer(programmer=orm_programmer)
...
async def create_programmer(programmer_data: schemas.ProgrammerData) -> schemas.Programmer:
    ...
    programmer = await __to_schema_programmer(programmer=programmer)
    return programmer
...
async def update_programmer(programmer_id: int, programmer_data: schemas.ProgrammerData) -> schemas.Programmer:
    ...
    return await __to_schema_programmer(programmer=programmer)
...
async def delete_programmer(programmer_id: int) -> schemas.Programmer:
    ...
    cache = await __to_schema_programmer(programmer=programmer)
